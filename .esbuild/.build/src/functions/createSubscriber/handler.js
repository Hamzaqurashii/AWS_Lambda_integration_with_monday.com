...
// src/functions/createSubscriber/handler.ts
__export(exports, {
  main: () => main
});
...
var hello = async (event) => {
  let query = `mutation { add_subscribers_to_board (board_id: ${event.body.boardID}, user_ids: ${event.body.userID}, kind: owner) { id } }`;
  (0, import_axios.default)({
    url: "https://api.monday.com/v2",
    headers: {
      "Content-Type": "application/json",
      Authorization: "eyJhbGciOiJIUzI1NiJ9.eyJ0aWQiOjEzMzg0MTgwOSwidWlkIjoyNjA2MjgzOSwiaWFkIjoiMjAyMS0xMS0xOVQxMzoxODo0My4wODNaIiwicGVyIjoibWU6d3JpdGUiLCJhY3RpZCI6MTA0NjcwNTEsInJnbiI6InVzZTEifQ.DQg95S3fXRefbOFnYCf4b_dscoyeXwMBhXo7G1YMNME"
    },
    data: JSON.stringify({
      query
    })
